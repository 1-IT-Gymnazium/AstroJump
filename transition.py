...
def circular_fade(screen, mode="in", duration=500, max_radius=None, border_color=(255, 255, 255), border_thickness=15):
    """
    Performs a circular fade effect on a Pygame screen object. The fade can be configured to fade in, fade out,
    or both sequentially. This function is typically used for transition effects between scenes or menus.
