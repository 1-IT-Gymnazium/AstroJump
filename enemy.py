...
class Projectile:
    ...
    def __init__(self, x, y, direction, speed=10):
        ...
        self.image = pygame.image.load(
            "Graphics/laser_bullet/laser_bullet.png")
    ...
    def draw(self, screen, camera):
        ...
        screen.blit(self.image,
                    ((self.x + camera_x) - 5, (self.y + camera_y) + 40))
    ...
    def spawn_projectile(self):
        ...
        for projectile_x, projectile_y in self.game.find_cannons_position(16):
            if projectile_x is not None and projectile_y is not None:
                self.projectiles.append(Projectile(projectile_x * TILE_WIDTH,
                                                   projectile_y * TILE_HEIGHT,
                                                   "left"))
